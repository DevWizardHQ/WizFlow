  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor }]} edges={['top']}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        ...
        <ThemedView style={styles.section}>
          <ThemedText type="subtitle" style={styles.sectionTitle}>Customization</ThemedText>
          <SettingLink label="Manage Categories" href="/categories" icon="list" />
        </ThemedView>

        {/* Defaults Section */}
        <ThemedView style={styles.section}>
          <ThemedText type="subtitle" style={styles.sectionTitle}>Defaults</ThemedText>
          <SettingPicker
            label="Currency"
        ...
        <ThemedView style={styles.section}>
          ...
          <SettingLink label="Backup & Restore" href="/backup" icon="cloud-upload" />
          <SettingLink label="Export to CSV" href="/export" icon="document-text" />
          <SettingLink label="Import from CSV" href="/import" icon="document-text-outline" />
          <SettingItem
        ...
        <ThemedView style={styles.section}>
          ...
          <SettingItem label="App Version" value={APP_VERSION} icon="information-circle" />

          <ThemedView style={styles.aboutInfo}>
            <ThemedText type="default" style={styles.appName}>{APP_NAME}</ThemedText>
