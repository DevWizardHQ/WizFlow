...
export default function BackupScreen() {
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert('Restore Failed', 'Could not restore data from the selected file.');
            } finally {
  ...
  return (
    <ThemedView style={styles.container}>
      <ThemedText type="title" style={styles.title}>Backup & Restore</ThemedText>
      <View style={styles.card}>
        ...
        <ThemedText style={styles.description}>
          Create a full backup of your data, including accounts, transactions, and settings. You can use this file to restore your data on any device.
        </ThemedText>
        <Button
          title="Create Backup"
      ...
      <View style={[styles.card, styles.restoreCard]}>
        ...
        <ThemedText style={styles.description}>
          Restore your data from a previously created backup file. This will overwrite all existing data.
        </ThemedText>
        <Button
