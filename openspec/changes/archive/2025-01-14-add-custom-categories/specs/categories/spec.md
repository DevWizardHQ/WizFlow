...
#### Scenario: Reassign Transactions
- **Given** category has transactions
- **When** user chooses to reassign
- **Then** category picker appears
- **And** all transactions are moved to selected category
- **And** original category is deleted
...
#### Scenario: Reorder Categories (Optional)
- **Given** user is on categories screen
- **When** user initiates reorder mode
- **Then** categories can be dragged to new positions
